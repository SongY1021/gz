			...
			<div class="uni-tree-item" :key="getId(item)">
				<div class="uni-tree-item-self">
					<div class="uni-tree-item-checkbox-wrapper" v-if="canShowCheckbox(item)" @click="handleToggleCheck(currentLevelData[index])">
						<image class="uni-tree-item-checkbox-icon" :src="`/static/checkbox-2.png`" v-if="item._checked"></image>
						<image class="uni-tree-item-checkbox-icon" :src="`/static/checkbox-1.png`" v-else-if="item._indeterminate"></image>
...
<style>
	...
	.uni-tree-item-children .uni-tree-item {
		border-top: #E3E3E3 solid 1rpx;
	}
</style>